...
impl SelectorsParser {
    fn validate_component(
        ...
        match component {
            ...
            Component::Negation(selectors) => selectors.slice()
                .iter()
    ...
    fn validate_selectors(selector_list: &[selectors::parser::Selector<SelectorImplDescriptor>]) -> Result<(), SelectorError> {
    ...
    fn validate_nth(nth: &NthSelectorData) -> Result<(), SelectorError> {
        match nth.ty {
            selectors::parser::NthType::Child |
            selectors::parser::NthType::OfType => Ok(()),
            selectors::parser::NthType::LastChild |
            selectors::parser::NthType::OnlyChild |
            selectors::parser::NthType::LastOfType |
            selectors::parser::NthType::OnlyOfType => Err(SelectorError::UnsupportedPseudoClassOrElement),
        }
    }
